/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1a28a39beee8d6d398a5e58512cf3b5f)
// Runtime types generated with workerd@1.20260811.1 2026-08-21 nodejs_compat
interface __BaseEnv_Env {
	LIABILITY_REPORT_SNAPSHOTS: R2Bucket;
	HYPERDRIVE: Hyperdrive;
	ASSETS: Fetcher;
	AUTH_PROVIDER: "auth0-access";
	...
	AUTH0_ROLE_IDS: "{\"admin\":\"rol_eoDAJuWbdjwEzEln\",\"handler\":\"rol_dUEQWoUpRu5kzcqi\",\"reviewer\":\"rol_8WnIILDtpeyWuu3O\"}";
	NEON_AUTH_URL: "https://ep-polished-fog-a6xt57b1.neonauth.us-west-2.aws.neon.tech/neondb/auth";
	CHOICE_DATA_API_URL: "https://eastmoney.hasbai.xyz/data";
	AUTH0_MANAGEMENT_CLIENT_SECRET: string;
	DEBT_IMPORT_WORKFLOW: Workflow<Parameters<import("./src/worker").DebtImportWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_PROVIDER" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "AUTH0_DOMAIN" | "AUTH0_CLIENT_ID" | "AUTH0_MANAGEMENT_CLIENT_ID" | "AUTH0_ROLE_IDS" | "NEON_AUTH_URL" | "CHOICE_DATA_API_URL" | "AUTH0_MANAGEMENT_CLIENT_SECRET">> {}
}
